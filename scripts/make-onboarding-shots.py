...
def main() -> None:
    ...
    # ③ 共用視窗剛打開：把帳號貼進最上面那一格（「複製連結」不是這一步，別點）
    save_static('gsheet-share-1.png',
                shot(gs_sh1, (840, 270, 1870, 1180),
                     [((886, 465, 1815, 578), 1)],
                     out_w=880, blur=[avatar, (880, 680, 1290, 760)]))

    # ④ 貼上之後：②權限從「編輯者」改成「檢視者」 ③通知可以取消勾 ④按「傳送」
    save_static('gsheet-share-2.png',
                shot(gs_sh2, (840, 250, 1870, 1180),
                     [((1596, 445, 1815, 545), 2),
                      ((900, 650, 1140, 700), 3),
                      ((1660, 1055, 1815, 1120), 4)],
                     out_w=880, blur=[avatar]), steps=3)
