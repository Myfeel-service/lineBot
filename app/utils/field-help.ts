...
export const FIELD_HELP: Record<FieldHelpId, FieldHelpDef> = {
  ...
  oamAutoReply: {
    button: '教我怎麼關',
    title: '內建自動回應怎麼關？',
    // ⚠️ 2026-09-11 補「聊天」那一格（開通引導那支輪播同步改）：「聊天」關著的話，
    //    第⑤步要設的「聊天的回應方式」是掛在它底下的。⚠️ alt 原本還寫「三格」（09-06 改四格時漏改）。
    html: '到 <b>LINE 官方帳號後台</b>（綠色那個，跟取得第一組連線資訊的後台不同），照動畫做：<b>①</b> 點右上角「<b>設定</b>」→ <b>②</b> 左邊選「<b>回應設定</b>」→ <b>③</b> 確認「<b>聊天</b>」是<b>開的</b>（灰的就點一下）→ <b>④</b> 確認「<b>Webhook</b>」是<b>開的</b>（灰的就點一下）→ <b>⑤</b>「聊天的回應方式」選「<b>手動聊天</b>」——不要選「手動聊天＋自動回應訊息」。',
    image: ONBOARDING_SHOTS.oamAutoReplyAnim,
    alt: '循環動畫五格：①右上設定、②側欄回應設定、③聊天是開的、④Webhook 是開的、⑤選手動聊天',
