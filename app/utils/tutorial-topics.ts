  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: '知識庫體檢會幫你盯',
        description:
          '知識庫有狀況時，資料列表<strong>上方會出現「知識庫體檢」橫幅</strong>：同步失敗的資料、被標記「AI 答錯了」的知識會列在<strong>「要處理的事」</strong>，點分類就直接列出那幾筆，照著修完就好——不用自己一張張翻。下面灰色那幾行（內容較短、到期自動停用）<strong>是提醒不是待辦</strong>，想看再看。',
      },
    ],
  },
  {
