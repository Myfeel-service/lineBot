        ...
        <template v-if="planQuota">
          <div ref="quotaCard" class="message-card usage-card">
            ...
            <div class="card-section-stack">
              ...
              <!-- 收費透明度明文（2026-08-10 老闆問「使用者能看出哪些被收錢嗎」）：
                   不收錢的規則不能只藏在 hover 的 ⓘ 裡——明文寫出來，同時是「答不出來不扣則」的賣點 -->
              <p class="usage-hint usage-hint--muted">
                答不出來、轉真人的那句不扣——算的是 AI 真的出手回答的次數（含反問問清楚、含草稿模式擬給客服參考的）。
              </p>
            </div>
          </div>
