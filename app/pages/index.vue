      ...
      <div class="lp-wrap">
        ...
        <!-- 「AI 知識量」那半句的白話解釋是 09-06 老闆回饋補的（「知識庫兩份資料不好理解」）：
             ...
             ⚠️ 2026-09-08（使用者「方案卡下面的小字是否可以減少」）103 字 → 67 字、
                ...
                「我手上這份東西大概算幾條」。
             ⚠️ 同日第二輪（使用者「是否有些文案可以放在其他頁面」）67 → 47 字：**換算那半搬進
                常見問答**新開的一題（「AI 知識量的『一條』是什麼？」，見 `#faq` 那區）。
                為什麼是搬去 FAQ 而不是 `/product-info`：①那頁是金流風控的核對清單，塞產品
                說明會稀釋它的用途；②**FAQ 預設是收合的**——搬過去只多一行標題，展開後還有
                空間講得比一句話清楚。這裡刻意留下「一條＝AI 記住的一件事」＝挑方案當下就要
                懂的那一句，⛔別連定義一起搬走（那就回到 09-06 老闆說的「不好理解」）。 -->
        <p class="lp-plans__note lp-reveal">
          <b>AI 客服四個方案都能用</b>，差別只在<b>規模</b>。AI 知識量的一條<span class="lp-nb">＝AI 記住的一件事</span>；隨時可以升級或降級。
        </p>
