...
// 3. 剩下的只列「檯面上主打的」（FEATURED_PLAN_IDS，2026-09-04 起＝免費／399／799／1,499）
//    ＋客戶**自己目前的**方案——不在主打清單上的舊客戶仍要看得到自己在哪，才能續訂或期末降級。
//    2026-08-17 補上：當時的「只 show 399」（D-14）只改了官網，這張表照列全部申報價，
